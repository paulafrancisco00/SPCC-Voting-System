    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                $rtnReadVoters = $readVoters->READ_ARCHIVED_VOTERS();
                ?>
                <center>
                    ...
                    <button class="btn btn-danger" data-toggle="modal" data-target="#DeleteVoters">Permanent Delete Voters</button>
                </center>
                <br>
    ...
    <div class="modal fade" id="DeleteVoters">
        <div class="modal-dialog">
            <div class="modal-content border border-danger">
                ...
                <!-- Modal footer -->
                <div class="modal-footer">
                    <form method="POST" action="delete_all_archived_voters.php" role="form">
