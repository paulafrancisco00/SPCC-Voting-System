    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="add_org.php"><span class="glyphicon glyphicon-plus-sign"></span>Add Party List</a></li>
        ...
        <div class="col-md-12">
            ...
            if(!isset($_GET['organization'])) {
                ...
                <div class="logo-title">
                    ...
                    <table>
                        <tr>
                            <td><img src="../assets/img/spccLogo.png" style="width:70px;height:70px;"></td>
                            <td><br/>
                            ...
                            <?php if($rtnReadNomOrgPos) { ?>
                                <table class="table table-condensed table-striped">
                                    ...
                                    <?php while($rowCountVotes = $rtnReadNomOrgPos->fetch_assoc()) { ?>
                                        ...
                                        echo 
                                            $rowCountVotes['last_name'].' '. 
                                            $rowCountVotes['first_name'].' '.
                                            $rowCountVotes['middle_name']
                                        ;?></td>
