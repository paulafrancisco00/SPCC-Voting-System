                            ...
                            <tbody class="myTable">
                                <?php while($rowVoter = $rtnReadVoters->fetch_assoc()) { ?>
                                    <tr>
                                        ...
                                        <td class="noprint"><a href="/spccvotingsystem/admin/edit_voter.php?id=<?php echo $rowVoter['id']; ?>"><button class="btn btn-warning">Update</button></a></td>
                                        <td class="noprint"><a href="/spccvotingsystem/admin/delete_voter.php?id=<?php echo $rowVoter['id']; ?>"><button class="btn btn-danger">Delete</button></a></td>
                                    </tr>
                                <?php } //End while ?>
                            </tbody>
                        </table>
