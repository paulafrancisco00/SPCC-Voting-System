            ...
            <div class="col-md-12">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <div class="form-group-sm">
                            <?php 
                            $res = mysqli_query($db, "SELECT DISTINCT grade FROM manage_section");
                            if($res){
                                while($row = mysqli_fetch_assoc($res)){
                                    echo '<div class="form-check dropdown-item">
                                    <label class="form-check-label dropdown-item">
                                    <input type="checkbox" name="gradebox" class="form-check-input" value="'.$row['grade'].'" onchange="filterme()">';
                                    echo $row["grade"];
                                    echo '</label>
                                    </div>';      
                                }
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <div class="form-group-sm">
                            <?php 
                            $res = mysqli_query($db, "SELECT DISTINCT strand FROM manage_section");
                            if($res){
                                while($row = mysqli_fetch_assoc($res)){
                                    echo '<div class="form-check dropdown-item">
                                    <label class="form-check-label dropdown-item">
