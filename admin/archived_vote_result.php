    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <button  class="btn btn-outline-primary pull-right btnPrint" style="margin-right: 10px !important;" >Print Data</button>  
              <!--  <button  class="btn btn-outline-danger" data-toggle="modal" data-target="#DeleteToArchivedVotes">Delete All Data</button>  
        ...
        <div class="modal-dialog">
            <div class="modal-content border border-danger">
                ...
                <div class="modal-body">
                    ...
                    <h5>You are about to Delete All Votes! All the data will be not recoverable but sent to Archived Voters. Do you still want to delete votes?</h5>
